...
import static no.difi.oxalis.as4.util.AS4ErrorCode.Category.*;
import static no.difi.oxalis.as4.util.AS4ErrorCode.Origin.EBMS;
import static no.difi.oxalis.as4.util.AS4ErrorCode.Origin.SECURITY;
